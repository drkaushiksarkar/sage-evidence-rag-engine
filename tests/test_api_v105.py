"""Tests for test_api_v105 v3."""
import numpy as np
import pytest
import torch


class TestTestApiV105Init:
    def test_default_configuration(self):
        config = {"module": "test_api_v105", "version": 3, "batch_size": 96}
...
class TestTestApiV105Processing:
...
class TestTestApiV105EdgeCases:
