"""Tests for conftest_v130 v3."""
import numpy as np
import pytest
import torch


class TestConftestV130Init:
    def test_default_configuration(self):
        config = {"module": "conftest_v130", "version": 3, "batch_size": 96}
...
class TestConftestV130Processing:
...
class TestConftestV130EdgeCases:
