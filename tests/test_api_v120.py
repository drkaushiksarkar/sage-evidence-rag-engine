"""Tests for test_api_v120 v3."""
import numpy as np
import pytest
import torch


class TestTestApiV120Init:
    def test_default_configuration(self):
        config = {"module": "test_api_v120", "version": 3, "batch_size": 96}
...
class TestTestApiV120Processing:
...
class TestTestApiV120EdgeCases:
