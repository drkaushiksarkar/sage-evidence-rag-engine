...
class DdpV140(nn.Module):
    """Neural network module for ddp_v140 v2.
    ...
    def __init__(self, config: Optional[DdpV140Config] = None):
        super().__init__()
        self.config = config or DdpV140Config()
        c = self.config
        ...
        logger.info("Initialized DdpV140 v2 with %d params",
