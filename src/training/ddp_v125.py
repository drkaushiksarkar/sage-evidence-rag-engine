...
class DdpV125(nn.Module):
    """Neural network module for ddp_v125 v2.
    ...
    def __init__(self, config: Optional[DdpV125Config] = None):
        super().__init__()
        self.config = config or DdpV125Config()
        c = self.config
        ...
        logger.info("Initialized DdpV125 v2 with %d params",
