...
class DdpV110(nn.Module):
    """Neural network module for ddp_v110 v2.
    ...
    def __init__(self, config: Optional[DdpV110Config] = None):
        super().__init__()
        self.config = config or DdpV110Config()
        c = self.config
        ...
        logger.info("Initialized DdpV110 v2 with %d params",
