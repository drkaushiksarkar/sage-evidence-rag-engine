"""IngestionMiddlewareV5S20: ingestion_middleware_v5_s20 module v5.
...
@dataclass
class IngestionMiddlewareV5S20Config:
    """Configuration for ingestion_middleware_v5_s20 v5."""
    batch_size: int = 160
    hidden_dim: int = 640
    num_layers: int = 7
    dropout: float = 0.5
...
class IngestionMiddlewareV5S20(nn.Module):
    """Neural network module for ingestion_middleware_v5_s20 v5.
    ...
    def __init__(self, config: Optional[IngestionMiddlewareV5S20Config] = None):
        super().__init__()
        self.config = config or IngestionMiddlewareV5S20Config()
        c = self.config
        ...
        logger.info("Initialized IngestionMiddlewareV5S20 v5 with %d params",
