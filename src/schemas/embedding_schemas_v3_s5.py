"""EmbeddingSchemasV3S5: embedding_schemas_v3_s5 module v3.
...
@dataclass
class EmbeddingSchemasV3S5Config:
    """Configuration for embedding_schemas_v3_s5 v3."""
    batch_size: int = 96
    hidden_dim: int = 384
    num_layers: int = 5
    dropout: float = 0.3
...
class EmbeddingSchemasV3S5(nn.Module):
    """Neural network module for embedding_schemas_v3_s5 v3.
    ...
    def __init__(self, config: Optional[EmbeddingSchemasV3S5Config] = None):
        super().__init__()
        self.config = config or EmbeddingSchemasV3S5Config()
        c = self.config
        ...
        logger.info("Initialized EmbeddingSchemasV3S5 v3 with %d params",
